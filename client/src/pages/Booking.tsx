      ...
      <div className="min-h-screen pt-20 flex items-center justify-center px-4">
        <Card className="max-w-md w-full">
          <CardContent className="pt-6 text-center">
            ...
            <h2 className="font-serif text-2xl font-bold mb-2">Thank you, {formData.fullName}!</h2>
    ...
    <div className="min-h-screen pt-20">
      <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">Book Your Private Journey</h1>
